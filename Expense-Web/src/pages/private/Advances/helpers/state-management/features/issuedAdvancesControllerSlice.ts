...
export const issuedAdvancesControllerSlice = createSlice({
  name: "issuedAdvancesController",
  initialState,
  reducers: {
...
export const { setSearchTextFilter, setPage, setPerPage, setSorting } =
  issuedAdvancesControllerSlice.actions;
export default issuedAdvancesControllerSlice.reducer;

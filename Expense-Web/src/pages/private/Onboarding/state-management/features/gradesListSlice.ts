...
export const gradesListControllerSlice = createSlice({
  name: "gradesListController",
  initialState,
  reducers: {
...
export const { setSearchTextFilter, setPage, setPerPage } =
  gradesListControllerSlice.actions;
export default gradesListControllerSlice.reducer;

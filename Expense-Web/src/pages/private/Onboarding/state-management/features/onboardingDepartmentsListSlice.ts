...
export const onboardingDepartmentsListSlice = createSlice({
  name: "onboardingDepartmentsList",
  initialState,
  reducers: {
...
export const { setSearchTextFilter, setPage, setPerPage } =
  onboardingDepartmentsListSlice.actions;
export default onboardingDepartmentsListSlice.reducer;

...
export const financeExpensesListControllerSlice = createSlice({
  name: "financeExpensesListController",
  initialState,
  reducers: {
...
export const { setSearchTextFilter, setPage, setPerPage } =
  financeExpensesListControllerSlice.actions;
export default financeExpensesListControllerSlice.reducer;

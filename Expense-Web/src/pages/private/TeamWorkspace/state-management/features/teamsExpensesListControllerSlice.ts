...
export const teamsExpensesListControllerSlice = createSlice({
  name: "teamsExpensesListController",
  initialState,
  reducers: {
...
export const { setSearchTextFilter, setColumnFilters, setPage, setPerPage } =
  teamsExpensesListControllerSlice.actions;
export default teamsExpensesListControllerSlice.reducer;

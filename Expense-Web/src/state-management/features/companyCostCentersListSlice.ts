...
export const companyCostCentersListSlice = createSlice({
  name: "companyCostCentersList",
  initialState,
  reducers: {
...
export const { setSearchTextFilter, setPage, setPerPage } =
  companyCostCentersListSlice.actions;
export default companyCostCentersListSlice.reducer;
